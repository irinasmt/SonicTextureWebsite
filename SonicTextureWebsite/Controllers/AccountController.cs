    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                MailMessage mail = new MailMessage("you@yourcompany.com", model.Email);
                SmtpClient client = GenerateSmtpClient();
                ...
                if (result.Succeeded)
                {
                    ...
                    mail.Body = "Please confirm your account by clicking " + callbackUrl ;
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await authRepo.AddUsertoRole(userId, "Test");
            }
